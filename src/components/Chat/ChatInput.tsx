        ...
        <>
          <Box
            sx={{
              ...
              "&::-webkit-scrollbar-track": { background: "divider", borderRadius: "3px" },
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 0.5 }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                ...
                {totalFileSize > maxFileSize && (
                  <WarningIcon sx={{ fontSize: 16, color: "error.main", animation: "pulse 2s infinite" }} />
                )}
              </Box>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <Typography
                  ...
                  sx={{
                    opacity: 0.7,
                    color: totalFileSize > maxFileSize ? "error.main" : "inherit",
                    fontWeight: totalFileSize > maxFileSize ? "bold" : "normal",
                  }}
                >
            ...
            <LinearProgress
              ...
              sx={{
                ...
                "& .MuiLinearProgress-bar": {
                  borderRadius: 3,
                  backgroundColor: totalFileSize > maxFileSize ? "error.main" : "primary.main",
                  animation: totalFileSize > maxFileSize ? "pulse 2s infinite" : "none",
                },
              }}
            />
          </Box>
      ...
      <Box sx={{ display: "flex", gap: 1, alignItems: "flex-end" }}>
        ...
        <Tooltip title={isLoading ? stopGenerationLabel : placeholder}>
          <IconButton
            ...
            disabled={isLoading ? false : !inputText.trim() || totalFileSize > maxFileSize}
            sx={{
              minWidth: 56,
              height: 56,
              ...(isLoading && { border: "2px solid #f44336", borderRadius: "50%" }),
            }}
          >
